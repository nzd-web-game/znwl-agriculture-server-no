...
public class PlatformAddPartitionsInputBO {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (!(paramObject instanceof PlatformAddPartitionsInputBO))
      return false; 
    paramObject = paramObject;
    PlatformAddPartitionsInputBO platformAddPartitionsInputBO;
    if (!(platformAddPartitionsInputBO = this instanceof PlatformAddPartitionsInputBO))
      return false; 
  ...
  private static boolean a(PlatformAddPartitionsInputBO paramPlatformAddPartitionsInputBO) {
    return paramPlatformAddPartitionsInputBO instanceof PlatformAddPartitionsInputBO;
  }
  ...
  public String toString() {
    return "PlatformAddPartitionsInputBO(_id=" + get_id() + ", _partitionsName=" + get_partitionsName() + ", _plantingVarieties=" + get_plantingVarieties() + ", _plantingName=" + get_plantingName() + ", _plantingDate=" + get_plantingDate() + ", _ofGreenhouse=" + get_ofGreenhouse() + ", _notes=" + get_notes() + ")";
  }
  
  public PlatformAddPartitionsInputBO() {}
  
  public PlatformAddPartitionsInputBO(BigInteger paramBigInteger, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6) {
    this.a = paramBigInteger;
    this.b = paramString1;
    this.c = paramString2;
    this.d = paramString3;
...
/* Location:              D:\apache-maven-3.9.2\Repository\vip\blockchain\agriculture\resources\1.0.0-SNAPSHOT\resources-1.0.0-SNAPSHOT.jar!\vip\blockchain\agriculture\model\bo\PlatformAddPartitionsInputBO.class
