...
public class PartitionsModifyFoodInputBO {
  private String a;
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (!(paramObject instanceof PartitionsModifyFoodInputBO))
      return false; 
    paramObject = paramObject;
    PartitionsModifyFoodInputBO partitionsModifyFoodInputBO;
    if (!(partitionsModifyFoodInputBO = this instanceof PartitionsModifyFoodInputBO))
      return false; 
    String str2 = get_id();
  ...
  private static boolean a(PartitionsModifyFoodInputBO paramPartitionsModifyFoodInputBO) {
    return paramPartitionsModifyFoodInputBO instanceof PartitionsModifyFoodInputBO;
  }
  ...
  public String toString() {
    return "PartitionsModifyFoodInputBO(_id=" + get_id() + ", _foodName=" + get_foodName() + ", _quality=" + get_quality() + ", _weight=" + get_weight() + ", _notes=" + get_notes() + ")";
  }
  
  public PartitionsModifyFoodInputBO() {}
  
  public PartitionsModifyFoodInputBO(String paramString1, String paramString2, BigInteger paramBigInteger, String paramString3, String paramString4) {
    this.a = paramString1;
    this.b = paramString2;
    this.c = paramBigInteger;
    this.d = paramString3;
...
/* Location:              D:\apache-maven-3.9.2\Repository\vip\blockchain\agriculture\resources\1.0.0-SNAPSHOT\resources-1.0.0-SNAPSHOT.jar!\vip\blockchain\agriculture\model\bo\PartitionsModifyFoodInputBO.class
