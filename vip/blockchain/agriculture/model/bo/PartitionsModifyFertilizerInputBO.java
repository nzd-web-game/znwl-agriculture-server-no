...
public class PartitionsModifyFertilizerInputBO {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (!(paramObject instanceof PartitionsModifyFertilizerInputBO))
      return false; 
    paramObject = paramObject;
    PartitionsModifyFertilizerInputBO partitionsModifyFertilizerInputBO;
    if (!(partitionsModifyFertilizerInputBO = this instanceof PartitionsModifyFertilizerInputBO))
      return false; 
  ...
  private static boolean a(PartitionsModifyFertilizerInputBO paramPartitionsModifyFertilizerInputBO) {
    return paramPartitionsModifyFertilizerInputBO instanceof PartitionsModifyFertilizerInputBO;
  }
  ...
  public String toString() {
    return "PartitionsModifyFertilizerInputBO(_id=" + get_id() + ", _date=" + get_date() + ", _fertilizerNme=" + get_fertilizerNme() + ", _fertilizerNumber=" + get_fertilizerNumber() + ", _notes=" + get_notes() + ")";
  }
  
  public PartitionsModifyFertilizerInputBO() {}
  
  public PartitionsModifyFertilizerInputBO(BigInteger paramBigInteger, String paramString1, String paramString2, String paramString3, String paramString4) {
    this.a = paramBigInteger;
    this.b = paramString1;
    this.c = paramString2;
    this.d = paramString3;
...
/* Location:              D:\apache-maven-3.9.2\Repository\vip\blockchain\agriculture\resources\1.0.0-SNAPSHOT\resources-1.0.0-SNAPSHOT.jar!\vip\blockchain\agriculture\model\bo\PartitionsModifyFertilizerInputBO.class
