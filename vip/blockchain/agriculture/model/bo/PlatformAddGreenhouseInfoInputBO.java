...
public class PlatformAddGreenhouseInfoInputBO {
  private String a;
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (!(paramObject instanceof PlatformAddGreenhouseInfoInputBO))
      return false; 
    paramObject = paramObject;
    PlatformAddGreenhouseInfoInputBO platformAddGreenhouseInfoInputBO;
    if (!(platformAddGreenhouseInfoInputBO = this instanceof PlatformAddGreenhouseInfoInputBO))
      return false; 
  ...
  private static boolean a(PlatformAddGreenhouseInfoInputBO paramPlatformAddGreenhouseInfoInputBO) {
    return paramPlatformAddGreenhouseInfoInputBO instanceof PlatformAddGreenhouseInfoInputBO;
  }
  ...
  public String toString() {
    return "PlatformAddGreenhouseInfoInputBO(_greenhouseName=" + get_greenhouseName() + ", _greenhouseArea=" + get_greenhouseArea() + ", _maxPartitionQuantity=" + get_maxPartitionQuantity() + ", _greenhousePosition=" + get_greenhousePosition() + ", _notes=" + get_notes() + ")";
  }
  
  public PlatformAddGreenhouseInfoInputBO() {}
  
  public PlatformAddGreenhouseInfoInputBO(String paramString1, String paramString2, BigInteger paramBigInteger, String paramString3, String paramString4) {
    this.a = paramString1;
    this.b = paramString2;
    this.c = paramBigInteger;
    this.d = paramString3;
...
/* Location:              D:\apache-maven-3.9.2\Repository\vip\blockchain\agriculture\resources\1.0.0-SNAPSHOT\resources-1.0.0-SNAPSHOT.jar!\vip\blockchain\agriculture\model\bo\PlatformAddGreenhouseInfoInputBO.class
