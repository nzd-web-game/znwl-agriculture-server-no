...
public class GreenhouseCtorBO {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == this)
      return true; 
    if (!(paramObject instanceof GreenhouseCtorBO))
      return false; 
    paramObject = paramObject;
    GreenhouseCtorBO greenhouseCtorBO;
    if (!(greenhouseCtorBO = this instanceof GreenhouseCtorBO))
      return false; 
  ...
  private static boolean a(GreenhouseCtorBO paramGreenhouseCtorBO) {
    return paramGreenhouseCtorBO instanceof GreenhouseCtorBO;
  }
  ...
  public String toString() {
    return "GreenhouseCtorBO(_greenhouseName=" + get_greenhouseName() + ", _greenhouseArea=" + get_greenhouseArea() + ", _maxPartitionQuantity=" + get_maxPartitionQuantity() + ", _greenhousePosition=" + get_greenhousePosition() + ", _notes=" + get_notes() + ")";
  }
  
  public GreenhouseCtorBO() {}
  
  public GreenhouseCtorBO(String paramString1, String paramString2, BigInteger paramBigInteger, String paramString3, String paramString4) {
    this.a = paramString1;
    this.b = paramString2;
    this.c = paramBigInteger;
    this.d = paramString3;
...
/* Location:              D:\apache-maven-3.9.2\Repository\vip\blockchain\agriculture\resources\1.0.0-SNAPSHOT\resources-1.0.0-SNAPSHOT.jar!\vip\blockchain\agriculture\model\bo\GreenhouseCtorBO.class
