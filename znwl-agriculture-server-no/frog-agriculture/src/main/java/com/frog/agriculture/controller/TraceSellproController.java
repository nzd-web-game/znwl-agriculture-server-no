...
public class TraceSellproController extends BaseController
{
    ...
    @PreAuthorize("@ss.hasPermi('agriculture:sellpro:generateCode')")
    @PostMapping("generateCode")
    public AjaxResult generateCode(@RequestBody GenerateCodeParams generateCodePrameter)
    {
        return AjaxResult.success(traceSellproService.generateTraceCode(generateCodePrameter));
    }
}
