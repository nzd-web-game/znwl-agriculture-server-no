<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="path" label="路由名称(跳转首字母大写)" :show-overflow-tooltip="true"></el-table-column>
        ...
        <el-row>
          ...
          <el-col :span="24" v-if="form.menuType != 'M'">
            <el-form-item prop="perms">
              <el-input v-model="form.perms" type="textarea" placeholder="请输入权限标识" maxlength="100" />
              <span slot="label">
